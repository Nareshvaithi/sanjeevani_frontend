            ...
            <div className="w-fit h-auto flex justify-center relative">
                    <div className="w-auto grid grid-cols-4 gap-5">
                        <div className="flex justify-center flex-col items-center">
                            ...
                            <p className="text-[10px] md:text-sm lg:text-lg">Students Details</p>
                        </div>
                        <div className="flex justify-center flex-col items-center">
                            <div className="px-3 py-1 bg-green-400 rounded-full text-xl text-white">2</div>
                            <p className="text-[10px] md:text-sm lg:text-lg">Payment</p>
                        </div>
                        <div className="flex justify-center flex-col items-center">
                            <div className="px-3 py-1 bg-green-400 rounded-full text-xl text-white">3</div>
                            <p className="text-[10px] md:text-sm lg:text-lg">User Name</p>
                        </div>
                        <div className="flex justify-center flex-col items-center text-xl">
                            ...
                            <p className="text-[10px] md:text-sm lg:text-lg">Confirmation</p>
                        </div>
                    </div>
                    <div className="overflow-hidden absolute w-full translate-y-5 lg:translate-y-3 rounded-full -z-10">
