...
export const selectAdminDetailsField = (state) =>
  state.adminAuth.adminDetailsField;
export const selectAdminCredentialsField = (state) =>
  state.adminAuth.adminCredentialsField;
